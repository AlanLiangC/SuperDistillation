...
SD_DATASET = Registry('sd_dataset')
SD_DATAWRAPPER = Registry('sd_datawrapper')

from .nuscenes import NuScenesDataset
from .transforms.transform_3d import *
...
def get_dataloader(
    ...
    train_wrapper = SD_DATASET.build(
        train_dataset_config)
    val_wrapper = SD_DATASET.build(
        val_dataset_config)
