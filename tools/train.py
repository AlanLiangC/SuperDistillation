...
def main(local_rank, args):
    ...
    if local_rank == 0:
        ...
        from super_distillation.miscs.tb_wrapper import WrappedTBWriter
    ...
    # build model
    from super_distillation import models
    from super_distillation.datasets import get_dataloader
    from super_distillation.losses import SD_LOSS
    ...
    loss_func = SD_LOSS.build(cfg.loss).cuda()
    ...
    if cfg.resume_from and osp.exists(cfg.resume_from):
        ...
        try:
            ...
            from super_distillation.miscs.checkpoint_util import refine_load_from_sd
    ...
    grad_norm = 0
    from super_distillation.miscs.metric_util import MeanIoU
    miou_metric = MeanIoU(
        list(range(1, 17)),
        17, #17,
